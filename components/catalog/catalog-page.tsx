...
import { ArrowLeft, ChevronDown, Filter, Pencil, Search, SlidersHorizontal, Trash2, UserRound } from 'lucide-react'
...
export default function CatalogPage() {
  ...
  async function removeProduct(id: string, name: string) {
    if (!window.confirm(`Nonaktifkan produk "${name}"?`)) return
