...
import { Check, ChevronDown, ClipboardList, CreditCard, Database, FileText, LayoutDashboard, Menu, Package, Plus, QrCode, Receipt, Search, ShoppingCart, Trash2, UserRound, Wallet, X } from 'lucide-react'
...
const menuItems = [
  ...
  { label: 'Data master', icon: Database },
