...
import { Check, ChevronDown, ClipboardList, CreditCard, Database, FileText, History, Home, LayoutDashboard, Menu, Package, Plus, QrCode, Receipt, Search, ShoppingCart, Trash2, UserRound, Wallet, X } from 'lucide-react'
