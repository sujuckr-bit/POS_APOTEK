...
type MasterTables = {
  ...
  products: { Row: { id: string; name: string; sku: string; category_id: string | null; supplier_id: string | null; unit_id: string | null; abbreviation: string | null; medicine_group: string | null; composition: string | null; short_composition: string | null; has_tax: boolean; purchase_price: number; selling_price: number; minimum_stock: number; stock: number; is_active: boolean; created_at: string; updated_at: string }; Insert: { id?: string; name: string; sku?: string; category_id?: string | null; supplier_id?: string | null; unit_id?: string | null; abbreviation?: string | null; medicine_group?: string | null; composition?: string | null; short_composition?: string | null; has_tax?: boolean; purchase_price?: number; selling_price?: number; minimum_stock?: number; stock?: number; is_active?: boolean; created_at?: string; updated_at?: string }; Update: Partial<MasterTables['products']['Insert']>; Relationships: [] }
  product_packaging: { Row: { id: string; product_id: string; name: string; abbreviation: string; quantity: number; unit_id: string; created_at: string }; Insert: { id?: string; product_id: string; name: string; abbreviation: string; quantity: number; unit_id: string; created_at?: string }; Update: Partial<MasterTables['product_packaging']['Insert']>; Relationships: [] }
}
